...
namespace DViewer
{
    public sealed class MainViewModel : INotifyPropertyChanged
    {
        ...
        // Anzeige-Quelle (ItemsSource bindet auf dieses Property)
        ...
        // ---------- Combine ----------
        private bool _suppressRowChanged; // Reentrancy-Wächter
        ...
        // Tagliste (Vorschläge) füllen
        private readonly List<CombinedMetadataItem> _allCombined = new(); // (falls du später brauchst)
